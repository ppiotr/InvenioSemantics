...
public class HEPOntologyAccessor {
	...
	/** Constructor that receives the path of the file containing the HEP ontology */
	public HEPOntologyAccessor(String inputFileName) {
	  _inputFileName = inputFileName;
	  uploadModel();
	}

    /** It uploads the model in memory. This is not efficient but it works for a test. For production, a TDB or a database storage should be used instead */
	...
	/** This is a test method to show the the first 'limit' statements (triples) of the model
	 * @param limit maximum number of statements to be displayed. -1 if you want to display all the statements
	 */
	...
	/** This is a test method, to show the the first 'limit' statements (triples) of the model. It's a refined version of showStatements method
	 * @param limit maximum number of statements to be displayed. -1 if you want to display all the statements
	 */
	...
	/** This is a recursive auxiliary method used to display the recursive hierarchy of narrower terms of a concept
	 * @param r resource to be browsed in each invocation
	 * @param index number of commas to be shown in the output (it allows detecting the hierarchy)
	 */
	...
	/** This method displays the recursive hierarchy of narrower terms of 'concept'. It uses a selector to filter the statements of the model.
	 * @param r resource to be browsed in each invocation
	 * @param index number of commas to be shown in the output (it allows detecting the hierarchy)
	 */
    ...
    /** This method search all resources containing concept as preferred label or alternate label
